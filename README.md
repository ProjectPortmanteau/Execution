...
│   ├── spirits/                 # Spirit Soul Codes (Boolean, Roux, Seer)
│   ├── output/                  # Timestamped negotiation transcripts + reports
...
├── START_HERE.md               # Non-developer entry point
...
Full report: [`playground/output/PARALLEL_VS_SEQUENTIAL_REPORT.md`](playground/output/PARALLEL_VS_SEQUENTIAL_REPORT.md)
Cross-substrate portability report: [`playground/output/CROSS_SUBSTRATE_REPORT.md`](playground/output/CROSS_SUBSTRATE_REPORT.md)
...
| 3 | **[The Principled Playground](roadmap/PRINCIPLED_PLAYGROUND_CONCEPT.md)** - TRI-BRAIN multi-agent negotiation, tension scoring, Loom synthesis, Seer stress-test | ✅ v0.4 Live |
...
- **Start Here (non-developer entry point):** [START_HERE.md](START_HERE.md)
